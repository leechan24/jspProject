...
.room-kind, room1 h1, .intro, .intro2, .intro3, .intro4 {
	width: 800px;
...
<body>
<room1>
	<h1 align="center">STANDARD ROOM</h1>
	<div class="room-kind">
		<div class="room-kind2">
			<div id="light-Slider">
				<ul id="imageGallery">
					<li data-thumb="/JSP_Project/img/Room/1_01.jpg">
					<img src="/JSP_Project/img/Room/1_01.jpg"></li>
					<li data-thumb="/JSP_Project/img/Room/1_02.jpg">
					<img src="/JSP_Project/img/Room/1_02.jpg"></li>
					<li data-thumb="/JSP_Project/img/Room/1_03.jpg">
					<img src="/JSP_Project/img/Room/1_03.jpg"></li>
				</ul>
			</div>
			<div class="form">
				<form action="Reservation1.jsp" method="POST">
				<input type="hidden" name="Room_Name" value="standard">
				<input type="hidden" name="Room_Fee" value="150">
					<p>
						최저<br>
						<span class="room-price">&dollar;150 <br>
						</span>
					</p>
	...
	<div class="intro">
		객실 정보 : 최대인원: 2명 객실 크기: 260 ft<sup>2</sup><br> 침대 : 더블베드 1개
	</div>
	<div class="intro2">
		부담없는 고급스러움. 25m² 면적의 안락한 공간과 고급스러운 인테리어의 조화.<br>
		스탠다드 룸은 베이지그레이 및 화이트 컬러를 기본으로 한 모던한 감각의 객실입니다.
	</div>
	<div class="intro3">
		편의시설 : <i class="material-icons">computer</i> 컴퓨터 &nbsp; <i
			class="material-icons">wifi</i>무선인터넷&nbsp;
